#FILE1=$1
grep -v "#" input.csv| /gpsr/local/bin/perl -pe 's/,/\t/g' >mydata
/gpsr/local/bin/dos2unix -k mydata
/gpsr/local/bin/perl ./prog/hashmatch.pl ./extra_files/38_selGenes mydata 1 1 |cut -f1 -d# >mydata11
...
Rscript ./prog/one.R express express_log
...
/gpsr/local/bin/perl ./prog/mean_sd.pl ./extra_files/mean_38 ./extra_files/sd_38 tpose_log_final >tpose_log_normalize
/gpsr/local/bin/perl ./prog/col2svm.pl -i tpose_log_normalize -o out -s 0
/gpsr/local/bin/svm_classify out ./models/model_38hall out_svm
#/gpsr/local/bin/Rscript round1.R out_svm out_svm1
#/gpsr/software/R-2.7.0/bin/Rscript ./prog/round1.R out_svm out_svm1
Rscript ./prog/round1.R out_svm out_svm1

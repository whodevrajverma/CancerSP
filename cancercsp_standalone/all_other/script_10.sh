#FILE1=$1
grep -v "#" input_10.csv| /gpsr/local/bin/perl -pe 's/,/\t/g' >mydata
/gpsr/local/bin/dos2unix -k mydata
/gpsr/local/bin/perl ./prog/hashmatch.pl ./extra_files/10_selGenes mydata 1 1 |cut -f1 -d# >mydata11
...
/gpsr/local/bin/perl ./prog/mean_sd.pl ./extra_files/mean_10 ./extra_files/sd_10 tpose_log_final >tpose_log_normalize
/gpsr/local/bin/perl ./prog/col2svm.pl -i tpose_log_normalize -o out -s 0
/gpsr/local/bin/svm_classify out ./models/model_10 out_svm
